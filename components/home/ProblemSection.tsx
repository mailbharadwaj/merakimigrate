...
export function ProblemSection() {
  ...
  return (
    <div className="relative py-32 bg-gray-50 overflow-hidden">
      {/* Background elements */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-20">
          <div className="inline-block px-4 py-2 bg-red-50 border border-red-200 rounded-full mb-6">
            <span className="text-red-600 text-sm">The Problem</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          {problems.map((problem, index) => (
            <div 
              key={index} 
              className="group relative bg-white backdrop-blur-sm rounded-2xl border border-gray-200 p-8 hover:border-gray-300 hover:shadow-lg transition-all duration-300"
            >
              ...
              <div className="relative flex gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl mb-3 text-gray-900">{problem.title}</h3>
        ...
        <div className="relative bg-gradient-to-br from-red-50 to-orange-50 backdrop-blur-sm border border-red-200 rounded-2xl p-8 overflow-hidden shadow-md">
          <div className="absolute top-0 right-0 w-64 h-64 bg-red-100/50 rounded-full blur-3xl"></div>
          <div className="relative flex gap-6">
            ...
            <div>
              <h3 className="text-2xl mb-3 text-red-700">The Real Cost of Errors</h3>
